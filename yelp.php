...
//SQL QUERY to get the yelp reviews from the database
$sql = "select * from reviews where gsearchid=53";
$result = $conn->query($sql); ?>
...
if ($result->num_rows > 0) {
	...
	?>
      ...
      <div class="fakeimg"><font size="20"><?php echo $row["bus_name"];?></font>
	  <div><font size="5" color="grey"><?php echo $row["text"];?></font></div>
	  <div align="center"><font size="10" color="maroon"><?php echo $row["rating"];?>-star </font><img width="300" height="75" src="stars.png"></img></div></div>
